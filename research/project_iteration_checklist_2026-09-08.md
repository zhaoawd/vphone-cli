...
2026-09-16 最新状态：**A3 已完成，累计 18/28 项完成，10 项未完成。** 已修复客户机 HID 边缘标记缺失，rig2 26.1 / 23B85 EXP 的点击、拖动、长按、三档缩放、底部 Home 手势及按下中断线/重连通过，纯生产签名构建复验通过。其他版本与变体未验证；本组合原生 Home 手势不支持，点击与滚动回退保留。见 [A3 验收与支持范围](a3_touch_acceptance_2026-09-16.md)。E6、C4 等其他工作项状态不变，下文较早状态保留为历史记录。
