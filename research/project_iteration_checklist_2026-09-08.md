...
2026-09-16 最新状态：**A3、E6 已完成，累计 19/28 项完成，9 项未完成。** A3 已修复客户机 HID 边缘标记缺失，rig2 26.1 / 23B85 EXP 的输入矩阵通过，见 [A3 验收与支持范围](a3_touch_acceptance_2026-09-16.md)。E6 已完成 generation/presentation 隔离、未消费拒绝、客户机重启、QR 标准回调、视频跨 EOF 循环、系统相机动态显示和 neutral 策略验收，见 [E6 视频与应用验收](camera_e6_video_acceptance_2026-09-16.md)。其他版本与变体未验证；C4 继续暂停。下文较早状态保留为历史记录。
